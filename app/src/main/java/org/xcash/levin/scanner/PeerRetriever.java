...
package org.xcash.levin.scanner;

import org.xcash.levin.data.Bucket;
import org.xcash.levin.data.Section;
import org.xcash.levin.util.HexHelper;
import org.xcash.levin.util.LittleEndianDataInputStream;
import org.xcash.levin.util.LittleEndianDataOutputStream;
...
public class PeerRetriever implements Callable<PeerRetriever> {
    ...
    static private Section handshakeRequest() {
        ...
        byte[] networkId = Helper.hexToBytes("10104153486241651731008216a1a110"); // mainnet
        ...
        byte[] genesisHash =
                Helper.hexToBytes("557393c3e80695e94603e92b4dbf7a2b974c16cf12d1b470d2882916cbfee468");
