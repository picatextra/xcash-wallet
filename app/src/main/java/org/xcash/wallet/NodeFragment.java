    ...
    private class AsyncFindNodes extends AsyncTask<Void, NodeInfo, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if ((d.getRpcNodes().size() < NODES_TO_FIND) &&
                ...
                seedList.add(new NodeInfo(new InetSocketAddress("euseed1.x-cash.org",18280)));
                seedList.add(new NodeInfo(new InetSocketAddress("euseed2.x-cash.org",18280)));
                seedList.add(new NodeInfo(new InetSocketAddress("euseed3.x-cash.org",18280)));
                seedList.add(new NodeInfo(new InetSocketAddress("usseed1.x-cash.org",18280)));
                seedList.add(new NodeInfo(new InetSocketAddress("usseed2.x-cash.org",18280)));
                seedList.add(new NodeInfo(new InetSocketAddress("usseed3.x-cash.org",18280)));
                seedList.add(new NodeInfo(new InetSocketAddress("asiaseed1.x-cash.org",18280)));
                seedList.add(new NodeInfo(new InetSocketAddress("asiaseed2.x-cash.org",18280)));
                d.seedPeers(seedList);
                d.awaitTermination(NODES_TO_FIND);
            }
