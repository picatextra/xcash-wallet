...
import org.xcash.wallet.data.Node;
import org.xcash.wallet.data.NodeInfo;
import org.xcash.wallet.dialog.AboutFragment;
import org.xcash.wallet.dialog.CreditsFragment;
import org.xcash.wallet.dialog.HelpFragment;
import org.xcash.wallet.dialog.PrivacyFragment;
import org.xcash.wallet.ledger.Ledger;
import org.xcash.wallet.ledger.LedgerProgressDialog;
import org.xcash.wallet.model.NetworkType;
import org.xcash.wallet.model.Wallet;
import org.xcash.wallet.model.WalletManager;
import org.xcash.wallet.service.WalletService;
import org.xcash.wallet.util.Helper;
import org.xcash.wallet.util.KeyStoreHelper;
import org.xcash.wallet.util.LocaleHelper;
import org.xcash.wallet.util.MoneroThreadPoolExecutor;
import org.xcash.wallet.widget.Toolbar;
...
public class LoginActivity extends BaseActivity
    ...
    private void loadFavourites() {
        ...
        favouriteNodes.clear();
        Map<String, ?> storedNodes = getSharedPreferences(NODES_PREFS_NAME, MODE_PRIVATE).getAll();
    ...
    private void saveFavourites() {
        ...
        Timber.d("SAVE");
        SharedPreferences.Editor editor = getSharedPreferences(NODES_PREFS_NAME, MODE_PRIVATE).edit();
        editor.clear();
        int i = 1;
    ...
    private static final String ACTION_USB_PERMISSION = "org.xcash.wallet.USB_PERMISSION";
